...
let getColToolCellIndexByBoundary = (cells, boundary, conditionFn, container) => (
    cells.reduce((findIndex, cell) => {
...
let getColToolCellIndexesByBoundary = (cells, boundary, conditionFn, container) => (
    cells.reduce((findIndexes, cell) => {
    ...
    deleteColumn : {
        ...
        handler () {
            ...
            let colIndexes = getColToolCellIndexesByBoundary(
                this.columnToolCells,
                this.boundary,
                (cellRect, boundary) => cellRect.x + ERROR_LIMIT > boundary.x &&
