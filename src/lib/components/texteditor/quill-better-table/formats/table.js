...
class TableCellLine extends Block {
    ...
    static formats (domNode) {
        ...
        return CELL_ATTRIBUTES.concat(CELL_IDENTITY_KEYS).concat(['cell-bg'])
            .reduce((format, attribute) => {

                if (domNode.hasAttribute(`data-${attribute}`)) {

                    format[attribute] = domNode.getAttribute(`data-${attribute}`) || undefined;
...
class TableCell extends Container {
    ...
    static formats (domNode) {
        ...
        return CELL_ATTRIBUTES.reduce((format, attribute) => {
    ...
    formats () {
        ...
        return CELL_ATTRIBUTES.reduce((format, attribute) => {
            ...
            if (this.domNode.hasAttribute(attribute)) {
                ...
                format[attribute] = this.domNode.getAttribute(attribute);
    ...
    deleteRow (compareRect, editorWrapper) {
        ...
        fallCells.forEach(cell => {
            ...
            const refCell = cellsInNextRow.reduce((ref, compareCell) => {
                ...
                const compareRect2 = getRelativeRect(
        ...
        unmergingCells.forEach(tableCell => {
            ...
            if (cellRowspan > 1) {
                ...
                while (i > 1) {
                    ...
                    for (let span = cellColspan; span > 0; span--) {
