...
// rebuild delta
export let matchTableCell = (node, delta) => {
    ...
    return delta.reduce((newDelta, op) => {
      ...
      op.insert.startsWith('\n')) {
        ...
        } else if (op.attributes && op.attributes.background && op.attributes.background === convertToHex(cellBg)) {
...
export let matchTableHeader = (node, delta) => {
...
export let matchTable = (node, delta) => {
