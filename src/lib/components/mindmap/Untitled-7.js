    ...
    methods : {
        ...
        _removeOldDragPlaceholder : function () {
            ...
            if (this.data.dragLastHolderIndex > -1 && this.data.dragLastHolderParent) {
                ...
                console.log('remove', this.data.dragLastHolderIndex);
        ...
        _updateDragTarget : function (startDrag = false) {
            ...
            if (startDrag === true && dragTarget.hidden === false) {
                ...
                dragTarget.originNodeStyle = {
                    height : targetNode.getBBox().height - 1
                };
                ...
                //     isDragging : false,
                //     style : {
                //         height : dragTarget.originNodeStyle.height,
                //         fillOpacity : 1,
                //         radius : 6
                //     }
                // });
                // targetNode.getInEdges()[0].show();
                // targetNode.getKeyShape().remove();
                // this.data.graph.removeItem(targetNode);
                // targetNode.getInEdges()[0].destroy();
                // targetNode.destroy();
                ...
                console.log(500, dragTarget.originNodeStyle.height);
                targetNode.update({
                    isDragging : false,
                    style : {
                        fillOpacity : 1,
        ...
        _onNodeDrag : function () {
            ...
            this.data.graph.on('node:dragstart', evt => {
                ...
                if (!evt.item.destroyed && !evt.item.getModel().isRoot && evt.item.get('isMindNode')) {
        ...
        this.data.graph = new G6.TreeGraph({
            ...
            layout : {
                ...
                getHeight : d => {
                    ...
                    if (node) {
                        ...
                        if (node) {
                            ...
                            console.log(1001, node, node.getBBox().height);
                ...
                getVGap : d => {
                    ...
                    // if (node && node.getBBox().height > 50) {
