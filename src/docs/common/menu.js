export default {
    component : {
        ...
        '导航菜单<i class="tag update l1"></i>' : '/component/menu.html',
        '锚点导航<i class="tag new l1"></i>' : '/component/anchor.html',
        ...
        '评分<i class="tag new l1"></i>' : '/component/rate.html',
        '计数器<i class="tag update l1"></i>' : '/component/counter.html',
        下拉选择 : '/component/select.html',
        复选框组 : '/component/checkbox.html',
        单选框组 : '/component/radio.html',
        '穿梭框<i class="tag new l1"></i>' : '/component/transfer.html',
        '级联选择<i class="tag new l1"></i>' : '/component/cascader.html',
        ...
        '颜色选择器<i class="tag update l1"></i>' : '/component/colorpicker.html',
