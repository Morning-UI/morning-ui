export default {
    component : {
        ...
        '吸附<i class="tag new l3"></i>' : '/component/sticky.html',
        '面包屑<i class="tag update l3"></i>' : '/component/breadcrumbs.html',
        '小提示<i class="tag update l3"></i>' : '/component/tip.html',
        消息 : '/component/message.html',
        '音频<i class="tag new l3"></i>' : '/component/audio.html',
        '视频<i class="tag new l3"></i>' : '/component/video.html',
        表单组件 : null,
        '文本输入<i class="tag update l3"></i>' : '/component/textinput.html',
        '段落输入<i class="tag update l3"></i>' : '/component/textarea.html',
        '富文本编辑器<i class="tag new l3"></i>' : '/component/texteditor.html',
        开关 : '/component/switch.html',
        // 计数器<i class="tag new"></i> : 'b',
        '下拉选择<i class="tag update l3"></i>' : '/component/select.html',
        // 级联选择<i class="tag update"></i> : 'b',
        '复选框组<i class="tag update l3"></i>' : '/component/checkbox.html',
        '单选框组<i class="tag update l3"></i>' : '/component/radio.html',
        多项输入 : '/component/multiinput.html',
        多项表单输入 : '/component/multiform.html',
        '滑块输入<i class="tag new l3"></i>' : '/component/slider.html',
        // 多项文本输入 : 'b',
        时间选择器 : '/component/timepicker.html',
        '日期选择器<i class="tag update l3"></i>' : '/component/datepicker.html',
        '日期时间选择器<i class="tag update l3"></i>' : '/component/datetimepicker.html',
