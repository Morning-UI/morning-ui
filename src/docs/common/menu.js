export default {
    component : {
        ...
        '告示<i class="tag new l1"></i>' : '/component/alert.html',
        ...
        '计数器<i class="tag new l3"></i>' : '/component/counter.html',
