export default {
    component : {
        ...
        '栅格<i class="tag update l3"></i>' : '/component/grid.html',
        '卡片<i class="tag update l3"></i>' : '/component/card.html',
        ...
        // 树形控件 : 'b',
        '标签页<i class="tag update l3"></i>' : '/component/tab.html',
        ...
        '抽屉<i class="tag new l3"></i>' : '/component/drawer.html',
        // 消息提示 : 'b',
        '徽标<i class="tag update l2"></i>' : '/component/badge.html',
        '头像<i class="tag new l2"></i>' : '/component/avatar.html',
        '时间<i class="tag new l2"></i>' : '/component/time.html',
        ...
        '小提示<i class="tag update l2"></i>' : '/component/tip.html',
        ...
        '回到顶部<i class="tag new l2"></i>' : '/component/backtop.html',
        表单组件 : null,
        ...
        '时间选择器<i class="tag update l2"></i>' : '/component/timepicker.html',
        '日期选择器<i class="tag update l2"></i>' : '/component/datepicker.html',
        '日期时间选择器<i class="tag update l2"></i>' : '/component/datetimepicker.html',
