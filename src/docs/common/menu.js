export default {
    component : {
        ...
        // 消息提示 : 'b',
        '徽标<i class="tag update l3"></i>' : '/component/badge.html',
        '头像<i class="tag new l3"></i>' : '/component/avatar.html',
        '时间<i class="tag new l3"></i>' : '/component/time.html',
        ...
        '回到顶部<i class="tag new l3"></i>' : '/component/backtop.html',
        表单组件 : null,
        ...
        '时间选择器<i class="tag update l3"></i>' : '/component/timepicker.html',
