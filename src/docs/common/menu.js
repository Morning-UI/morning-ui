export default {
    component : {
        ...
        // 树形控件 : 'b',
        '标签页<i class="tag update l4"></i>' : '/component/tab.html',
        '折叠面板<i class="tag new l4"></i>' : '/component/collapse.html',
        ...
        '进度条<i class="tag new"></i>' : '/component/progress.html',
        吸附 : '/component/sticky.html',
        '步骤条<i class="tag coming"></i>' : 'b',
        ...
        '计数器<i class="tag new l2"></i>' : '/component/counter.html',
