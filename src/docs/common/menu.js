export default {
    component : {
        ...
        '栅格<i class="tag update l2"></i>' : '/component/grid.html',
        '卡片<i class="tag update l2"></i>' : '/component/card.html',
        ...
        // 树形控件 : 'b',
        '标签页<i class="tag update l2"></i>' : '/component/tab.html',
        ...
        '回到顶部<i class="tag new l1"></i>' : '/component/backtop.html',
        表单组件 : null,
        ...
        '时间选择器<i class="tag update l1"></i>' : '/component/timepicker.html',
