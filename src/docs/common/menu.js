export default {
    component : {
        ...
        '栅格<i class="tag update l1"></i>' : '/component/grid.html',
        '卡片<i class="tag update l1"></i>' : '/component/card.html',
        ...
        '树状控件<i class="tag new l3"></i>' : '/component/tree.html',
        表格 : '/component/table.html',
        '导航菜单<i class="tag update l3"></i>' : '/component/menu.html',
        '锚点导航<i class="tag new l3"></i>' : '/component/anchor.html',
        分页 : '/component/pagination.html',
        '模拟盒<i class="tag update l3"></i>' : '/component/dialog.html',
        '抽屉<i class="tag new l1"></i>' : '/component/drawer.html',
        // 消息提示 : 'b',
        '时间<i class="tag new"></i>' : '/component/time.html',
        日历 : '/component/calendar.html',
        加载 : '/component/load.html',
        进度条 : '/component/progress.html',
        '空状态<i class="tag new l3"></i>' : '/component/empty.html',
        ...
        '评分<i class="tag new l3"></i>' : '/component/rate.html',
        '计数器<i class="tag update l3"></i>' : '/component/counter.html',
        下拉选择 : '/component/select.html',
        复选框组 : '/component/checkbox.html',
        单选框组 : '/component/radio.html',
        '穿梭框<i class="tag new l3"></i>' : '/component/transfer.html',
        '级联选择<i class="tag new l3"></i>' : '/component/cascader.html',
