export default {
    component : {
        ...
        '树状控件<i class="tag new l2"></i>' : '/component/tree.html',
        表格 : '/component/table.html',
        '导航菜单<i class="tag update l2"></i>' : '/component/menu.html',
        '锚点导航<i class="tag new l2"></i>' : '/component/anchor.html',
        分页 : '/component/pagination.html',
        '模拟盒<i class="tag update l2"></i>' : '/component/dialog.html',
        ...
        '评分<i class="tag new l2"></i>' : '/component/rate.html',
        '计数器<i class="tag update l2"></i>' : '/component/counter.html',
        下拉选择 : '/component/select.html',
        复选框组 : '/component/checkbox.html',
        单选框组 : '/component/radio.html',
        '穿梭框<i class="tag new l2"></i>' : '/component/transfer.html',
        '级联选择<i class="tag new l2"></i>' : '/component/cascader.html',
        ...
        '颜色选择器<i class="tag update l2"></i>' : '/component/colorpicker.html',
