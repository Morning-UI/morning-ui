<template>
    ...
    ### 0.12.80 <ui-badge class="circle ver-canary" size="s" color="neutral-9">Beta</ui-badge>

    <ui-textcolor color="neutral-8">
        <ui-small>
            发布于2020年3月4日，
            Archive :
            <a href="https://github.com/Morning-UI/morning-ui/releases/tag/0.12.80" target="_blank">Package</a>
            <a href="https://cdn.jsdelivr.net/npm/morning-ui@0.12.80/dist/" target="_blank">jsdelivr(CDN)</a>
            <a href="https://unpkg.com/morning-ui@0.12.80/dist/" target="_blank">unpkg(CDN)</a>
        </ui-small>
    </ui-textcolor>

    #### 新特性

    - `ui-tab`的`append`和`prepend`配置支持Vue组件

    #### 修复

    - 修复`ui-table`在嵌套子内容时某些特殊场景下会出现某行消失的问题
    ...
    <ui-textcolor color="neutral-8">
        <ui-small>
            ...
            <a href="https://unpkg.com/morning-ui@0.12.78/dist/" target="_blank">unpkg(CDN)</a>
        </ui-small>
    </ui-textcolor>

    #### 修复

    - `ui-imagemap`组件在某些情况下视图无法更新组件值的问题
    ...
    <ui-textcolor color="neutral-8">
        <ui-small>
            发布于2020年2月15日，
            Archive :
            <a href="https://github.com/Morning-UI/morning-ui/releases/tag/0.12.74" target="_blank">Package</a>
            <a href="https://cdn.jsdelivr.net/npm/morning-ui@0.12.74/dist/" target="_blank">jsdelivr(CDN)</a>
            <a href="https://unpkg.com/morning-ui@0.12.74/dist/" target="_blank">unpkg(CDN)</a>
        </ui-small>
    </ui-textcolor>
    ...
    <ui-textcolor color="neutral-8">
        <ui-small>
            发布于2019年11月21日，
            Archive :
            <a href="https://github.com/Morning-UI/morning-ui/releases/tag/0.12.71" target="_blank">Package</a>
            <a href="https://cdn.jsdelivr.net/npm/morning-ui@0.12.71/dist/" target="_blank">jsdelivr(CDN)</a>
            <a href="https://unpkg.com/morning-ui@0.12.71/dist/" target="_blank">unpkg(CDN)</a>
        </ui-small>
    </ui-textcolor>
    ...
    ### 0.12.70 <ui-badge class="circle ver-beta" size="s" color="neutral-9">Beta</ui-badge>

    <ui-textcolor color="neutral-8">
        <ui-small>
            发布于2019年11月15日，
            Archive :
            <a href="https://github.com/Morning-UI/morning-ui/releases/tag/0.12.70" target="_blank">Package</a>
            <a href="https://cdn.jsdelivr.net/npm/morning-ui@0.12.70/dist/" target="_blank">jsdelivr(CDN)</a>
            <a href="https://unpkg.com/morning-ui@0.12.70/dist/" target="_blank">unpkg(CDN)</a>
        </ui-small>
    </ui-textcolor>
    ...
    ### 0.12.69 <ui-badge class="circle ver-beta" size="s" color="neutral-9">Beta</ui-badge>

    <ui-textcolor color="neutral-8">
        <ui-small>
            发布于2019年11月13日，
            Archive :
            <a href="https://github.com/Morning-UI/morning-ui/releases/tag/0.12.69" target="_blank">Package</a>
            <a href="https://cdn.jsdelivr.net/npm/morning-ui@0.12.69/dist/" target="_blank">jsdelivr(CDN)</a>
            <a href="https://unpkg.com/morning-ui@0.12.69/dist/" target="_blank">unpkg(CDN)</a>
        </ui-small>
    </ui-textcolor>
