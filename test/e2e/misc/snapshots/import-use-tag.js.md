# Snapshot report for `test/e2e/misc/import-use-tag.js`

The actual snapshot is saved in `import-use-tag.js.snap`.
...
> Snapshot 1

    {
      ...
      perspective: 'none',
      perspectiveOrigin: '9.59375px 9.09375px',
      pointerEvents: 'auto',
      position: 'relative',
      quotes: '',
      r: '0px',
      ...
      touchAction: 'auto',
      transform: 'none',
      transformOrigin: '9.59375px 9.09375px',
      transformStyle: 'flat',
