# Snapshot report for `test/e2e/components/multiform.js`
...
> Snapshot 1

    {
      style: {
        ...
        perspective: 'none',
        perspectiveOrigin: '150px 23.1875px',
...
> Snapshot 1
    ...
    {
      default: {
        '.itemlist > .name|undefined|background-color': 'rgb(240, 240, 240)',
        '.itemlist > .name|undefined|color': 'rgb(124, 139, 160)',
        '.itemlist|undefined|border-color': 'rgb(230, 230, 230)',
        '.itemwrap > .item|undefined|background-color': 'rgb(240, 240, 240)',
        '.itemwrap > .item|undefined|cursor': 'pointer',
      ...
      state_ndr: {
        disabled: {
          '.itemlist > .name|undefined|background-color': 'rgb(215, 215, 215)',
          '.itemlist > .name|undefined|color': 'rgb(98, 113, 135)',
          '.itemlist|undefined|border-color': 'rgb(166, 166, 166)',
          '.itemwrap > .item|undefined|background-color': 'rgb(215, 215, 215)',
          '.itemwrap > .item|undefined|cursor': 'not-allowed',
          'undefined|undefined|-webkit-user-select': 'none',
