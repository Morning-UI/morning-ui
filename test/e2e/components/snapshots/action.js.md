...
> Snapshot 1

    {
      color: {
        black: {
          '.title h5|color': 'rgb(23, 33, 45)',
        },
        blue: {
          '.title h5|color': 'rgb(124, 139, 160)',
        },
        danger: {
          '.title h5|color': 'rgb(214, 68, 49)',
        },
        'dark-theme': {
          '.title h5|color': 'rgb(210, 35, 67)',
        },
        'extra-light-black': {
          '.title h5|color': 'rgb(69, 80, 92)',
        },
        'extra-light-blue': {
          '.title h5|color': 'rgb(168, 179, 194)',
        },
        'extra-light-silver': {
          '.title h5|color': 'rgb(237, 241, 245)',
        },
        gray: {
          '.title h5|color': 'rgb(230, 230, 230)',
        },
        info: {
          '.title h5|color': 'rgb(3, 166, 185)',
        },
        'light-black': {
          '.title h5|color': 'rgb(48, 60, 75)',
        },
        'light-blue': {
          '.title h5|color': 'rgb(142, 156, 175)',
        },
        'light-gray': {
          '.title h5|color': 'rgb(240, 240, 240)',
        },
        'light-silver': {
          '.title h5|color': 'rgb(226, 232, 238)',
        },
        'light-theme': {
          '.title h5|color': 'rgb(248, 111, 136)',
        },
        minor: {
          '.title h5|color': 'rgb(169, 169, 169)',
        },
        primary: {
          '.title h5|color': 'rgb(33, 133, 208)',
        },
        silver: {
          '.title h5|color': 'rgb(214, 221, 229)',
        },
        success: {
          '.title h5|color': 'rgb(77, 189, 103)',
        },
        theme: {
          '.title h5|color': 'rgb(243, 61, 93)',
        },
        warning: {
          '.title h5|color': 'rgb(240, 173, 78)',
        },
        white: {
          '.title h5|color': 'rgb(255, 255, 255)',
        },
      },
      default: {
        '.title h5|color': 'rgb(23, 33, 45)',
...
> Snapshot 1

    {
      ...
      size: {
        ...
        s: {
          '.title .note|font-size': '12px',
          '.title h5|font-size': '13px',
        },
        xl: {
          '.title .note|font-size': '17.6px',
          '.title h5|font-size': '22.4px',
        },
        xs: {
          '.title .note|font-size': '12px',
        ...
        xxl: {
          '.title .note|font-size': '19.2px',
          '.title h5|font-size': '25.6px',
        },
        xxs: {
          '.title .note|font-size': '12px',
          '.title h5|font-size': '12px',
...
> Snapshot 1

    {
      vertical: {
        ...
        paintOrder: 'fill stroke markers',
        perspective: 'none',
        perspectiveOrigin: '200px 47.0938px',
        pointerEvents: 'auto',
        position: 'static',
        quotes: '',
        r: '0px',
