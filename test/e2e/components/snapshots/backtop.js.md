# Snapshot report for `test/e2e/components/backtop.js`
...
> Snapshot 1

    {
      style: {
        ...
        background: 'rgb(168, 179, 194) none repeat scroll 0% 0% / auto padding-box border-box',
        backgroundAttachment: 'scroll',
        backgroundBlendMode: 'normal',
        backgroundClip: 'border-box',
        backgroundColor: 'rgb(168, 179, 194)',
        ...
        baselineShift: '0px',
        blockSize: '40px',
        border: '0px none rgb(69, 80, 92)',
        borderBottom: '0px none rgb(69, 80, 92)',
        borderBottomColor: 'rgb(69, 80, 92)',
        borderBottomLeftRadius: '0px',
        borderBottomRightRadius: '0px',
        borderBottomStyle: 'none',
        borderBottomWidth: '0px',
        borderCollapse: 'separate',
        borderColor: 'rgb(69, 80, 92)',
        borderImage: 'none',
        ...
        borderImageWidth: '1',
        borderLeft: '0px none rgb(69, 80, 92)',
        borderLeftColor: 'rgb(69, 80, 92)',
        borderLeftStyle: 'none',
        borderLeftWidth: '0px',
        borderRadius: '0px',
        borderRight: '0px none rgb(69, 80, 92)',
        borderRightColor: 'rgb(69, 80, 92)',
        borderRightStyle: 'none',
        borderRightWidth: '0px',
        borderSpacing: '0px 0px',
        borderStyle: 'none',
        borderTop: '0px none rgb(69, 80, 92)',
        borderTopColor: 'rgb(69, 80, 92)',
        ...
        columnFill: 'balance',
        columnGap: 'normal',
        columnRule: '0px none rgb(69, 80, 92)',
        columnRuleColor: 'rgb(69, 80, 92)',
        ...
        floodOpacity: '1',
        font: 'normal normal normal normal 14px / 40px PingFangSC-Thin, sans-serif',
        ...
        orientation: '',
        orphans: '2',
        outline: 'rgb(69, 80, 92) none 0px',
        outlineColor: 'rgb(69, 80, 92)',
        outlineOffset: '0px',
        outlineStyle: 'none',
        outlineWidth: '0px',
        overflow: 'visible',
        ...
        textDecoration: 'none solid rgb(69, 80, 92)',
        textDecorationColor: 'rgb(69, 80, 92)',
        ...
        webkitBorderAfter: '0px none rgb(69, 80, 92)',
        webkitBorderAfterColor: 'rgb(69, 80, 92)',
        webkitBorderAfterStyle: 'none',
        webkitBorderAfterWidth: '0px',
        webkitBorderBefore: '0px none rgb(69, 80, 92)',
        webkitBorderBeforeColor: 'rgb(69, 80, 92)',
        webkitBorderBeforeStyle: 'none',
        webkitBorderBeforeWidth: '0px',
        webkitBorderEnd: '0px none rgb(69, 80, 92)',
        webkitBorderEndColor: 'rgb(69, 80, 92)',
        webkitBorderEndStyle: 'none',
        webkitBorderEndWidth: '0px',
        webkitBorderHorizontalSpacing: '0px',
        webkitBorderImage: 'none',
        webkitBorderStart: '0px none rgb(69, 80, 92)',
        webkitBorderStartColor: 'rgb(69, 80, 92)',
        ...
        webkitTextEmphasis: '',
        webkitTextEmphasisColor: 'rgb(69, 80, 92)',
        webkitTextEmphasisPosition: 'over',
        webkitTextEmphasisStyle: 'none',
        webkitTextFillColor: 'rgb(69, 80, 92)',
        webkitTextOrientation: 'vertical-right',
        webkitTextSecurity: 'none',
        webkitTextStroke: '',
        webkitTextStrokeColor: 'rgb(69, 80, 92)',
