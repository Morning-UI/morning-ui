# Snapshot report for `test/e2e/components/card.js`
...
> Snapshot 1

    {
      style: {
        ...
        webkitLocale: 'auto',
        webkitLogicalHeight: '240px',
        webkitLogicalWidth: '180px',
        ...
        webkitPaddingAfter: '14px',
        webkitPaddingBefore: '14px',
...
> Snapshot 1

    {
      color: {
        black: {
          ' header|undefined|background-color': 'rgb(23, 33, 45)',
          ' header|undefined|color': 'rgb(255, 255, 255)',
        },
        blue: {
          ' header|undefined|background-color': 'rgb(124, 139, 160)',
          ' header|undefined|color': 'rgb(255, 255, 255)',
        },
        danger: {
          ' header|undefined|background-color': 'rgb(214, 68, 49)',
          ' header|undefined|color': 'rgb(255, 255, 255)',
        },
        'dark-theme': {
          ' header|undefined|background-color': 'rgb(210, 35, 67)',
          ' header|undefined|color': 'rgb(255, 255, 255)',
        },
        'extra-light-black': {
          ' header|undefined|background-color': 'rgb(69, 80, 92)',
          ' header|undefined|color': 'rgb(255, 255, 255)',
        },
        'extra-light-blue': {
          ' header|undefined|background-color': 'rgb(168, 179, 194)',
          ' header|undefined|color': 'rgb(255, 255, 255)',
        },
        'extra-light-silver': {
          ' header|undefined|background-color': 'rgb(237, 241, 245)',
          ' header|undefined|color': 'rgb(48, 60, 75)',
        },
        gray: {
          ' header|undefined|background-color': 'rgb(230, 230, 230)',
          ' header|undefined|color': 'rgb(48, 60, 75)',
        },
        info: {
          ' header|undefined|background-color': 'rgb(3, 166, 185)',
          ' header|undefined|color': 'rgb(255, 255, 255)',
        },
        'light-black': {
          ' header|undefined|background-color': 'rgb(48, 60, 75)',
          ' header|undefined|color': 'rgb(255, 255, 255)',
        },
        'light-blue': {
          ' header|undefined|background-color': 'rgb(142, 156, 175)',
          ' header|undefined|color': 'rgb(255, 255, 255)',
        },
        'light-gray': {
          ' header|undefined|background-color': 'rgb(240, 240, 240)',
          ' header|undefined|color': 'rgb(48, 60, 75)',
        },
        'light-silver': {
          ' header|undefined|background-color': 'rgb(226, 232, 238)',
          ' header|undefined|color': 'rgb(48, 60, 75)',
        },
        'light-theme': {
          ' header|undefined|background-color': 'rgb(248, 111, 136)',
          ' header|undefined|color': 'rgb(255, 255, 255)',
        },
        minor: {
          ' header|undefined|background-color': 'rgb(169, 169, 169)',
          ' header|undefined|color': 'rgb(255, 255, 255)',
        },
        primary: {
          ' header|undefined|background-color': 'rgb(33, 133, 208)',
          ' header|undefined|color': 'rgb(255, 255, 255)',
        },
        silver: {
          ' header|undefined|background-color': 'rgb(214, 221, 229)',
          ' header|undefined|color': 'rgb(48, 60, 75)',
        },
        success: {
          ' header|undefined|background-color': 'rgb(77, 189, 103)',
          ' header|undefined|color': 'rgb(255, 255, 255)',
        },
        theme: {
          ' header|undefined|background-color': 'rgb(243, 61, 93)',
          ' header|undefined|color': 'rgb(255, 255, 255)',
        },
        warning: {
          ' header|undefined|background-color': 'rgb(240, 173, 78)',
          ' header|undefined|color': 'rgb(255, 255, 255)',
        },
        white: {
          ' header|undefined|background-color': 'rgb(255, 255, 255)',
          ' header|undefined|color': 'rgb(48, 60, 75)',
        },
      },
      default: {
