...
> Snapshot 1

    {
      color: {
        black: {
          ' header|background-color': 'rgb(23, 33, 45)',
          ' header|color': 'rgb(255, 255, 255)',
        },
        blue: {
          ' header|background-color': 'rgb(124, 139, 160)',
          ' header|color': 'rgb(255, 255, 255)',
        },
        danger: {
          ' header|background-color': 'rgb(214, 68, 49)',
          ' header|color': 'rgb(255, 255, 255)',
        },
        'dark-theme': {
          ' header|background-color': 'rgb(210, 35, 67)',
          ' header|color': 'rgb(255, 255, 255)',
        },
        'extra-light-black': {
          ' header|background-color': 'rgb(69, 80, 92)',
          ' header|color': 'rgb(255, 255, 255)',
        },
        'extra-light-blue': {
          ' header|background-color': 'rgb(168, 179, 194)',
          ' header|color': 'rgb(255, 255, 255)',
        },
        'extra-light-silver': {
          ' header|background-color': 'rgb(237, 241, 245)',
          ' header|color': 'rgb(48, 60, 75)',
        },
        gray: {
        ...
        info: {
          ' header|background-color': 'rgb(3, 166, 185)',
          ' header|color': 'rgb(255, 255, 255)',
        },
        'light-black': {
          ' header|background-color': 'rgb(48, 60, 75)',
          ' header|color': 'rgb(255, 255, 255)',
        },
        'light-blue': {
          ' header|background-color': 'rgb(142, 156, 175)',
          ' header|color': 'rgb(255, 255, 255)',
        },
        'light-gray': {
        ...
        'light-silver': {
          ' header|background-color': 'rgb(226, 232, 238)',
          ' header|color': 'rgb(48, 60, 75)',
        },
        'light-theme': {
          ' header|background-color': 'rgb(248, 111, 136)',
          ' header|color': 'rgb(255, 255, 255)',
        },
        minor: {
          ' header|background-color': 'rgb(169, 169, 169)',
          ' header|color': 'rgb(255, 255, 255)',
        },
        primary: {
          ' header|background-color': 'rgb(33, 133, 208)',
          ' header|color': 'rgb(255, 255, 255)',
        },
        silver: {
          ' header|background-color': 'rgb(214, 221, 229)',
          ' header|color': 'rgb(48, 60, 75)',
        },
        success: {
          ' header|background-color': 'rgb(77, 189, 103)',
          ' header|color': 'rgb(255, 255, 255)',
        },
        theme: {
          ' header|background-color': 'rgb(243, 61, 93)',
          ' header|color': 'rgb(255, 255, 255)',
        },
        warning: {
          ' header|background-color': 'rgb(240, 173, 78)',
          ' header|color': 'rgb(255, 255, 255)',
        },
        white: {
