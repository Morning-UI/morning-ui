# Snapshot report for `test/e2e/components/btngroup.js`
...
> Snapshot 1

    {
      style: {
        ...
        perspective: 'none',
        perspectiveOrigin: '136.688px 18px',
        pointerEvents: 'auto',
        position: 'relative',
        quotes: '',
        r: '0px',
        ...
        touchAction: 'auto',
        transform: 'none',
        transformOrigin: '136.688px 18px',
        transformStyle: 'flat',
...
> Snapshot 1

    {
      nogap: {
        ...
        paintOrder: 'fill stroke markers',
        perspective: 'none',
        perspectiveOrigin: '54.5938px 18px',
        pointerEvents: 'auto',
        position: 'relative',
        quotes: '',
        r: '0px',
        ...
        touchAction: 'auto',
        transform: 'none',
        transformOrigin: '54.5938px 18px',
        transformStyle: 'flat',
        transition: 'all 0s ease 0s',
        transitionDelay: '0s',
        transitionDuration: '0s',
...
> Snapshot 1

    {
      vertical: {
        ...
        paintOrder: 'fill stroke markers',
        perspective: 'none',
        perspectiveOrigin: '33.7969px 74.2812px',
        pointerEvents: 'auto',
        position: 'relative',
        quotes: '',
        r: '0px',
        ...
        touchAction: 'auto',
        transform: 'none',
        transformOrigin: '33.7969px 74.2812px',
        transformStyle: 'flat',
        transition: 'all 0s ease 0s',
        transitionDelay: '0s',
        transitionDuration: '0s',
