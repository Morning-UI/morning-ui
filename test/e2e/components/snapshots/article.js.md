# Snapshot report for `test/e2e/components/article.js`
...
> Snapshot 1

    {
      style: {
        ...
        floodOpacity: '1',
        font: 'normal normal normal normal 14px / 25.2px PingFangSC-Thin, sans-serif',
        ...
        perspective: 'none',
        perspectiveOrigin: '389px 115.25px',
        pointerEvents: 'auto',
        position: 'static',
        quotes: '',
        r: '0px',
        ...
        touchAction: 'auto',
        transform: 'none',
        transformOrigin: '389px 115.25px',
        transformStyle: 'flat',
...
> Snapshot 1

    {
      underline: {
        ...
        paintOrder: 'fill stroke markers',
        perspective: 'none',
        perspectiveOrigin: '389px 118.953px',
        pointerEvents: 'auto',
        position: 'static',
        quotes: '',
        r: '0px',
        ...
        touchAction: 'auto',
        transform: 'none',
        transformOrigin: '389px 118.953px',
        transformStyle: 'flat',
        transition: 'all 0s ease 0s',
        transitionDelay: '0s',
        transitionDuration: '0s',
