# Snapshot report for `test/e2e/components/divider.js`
...
> Snapshot 1

    {
      style: {
        ...
        perspective: 'none',
        perspectiveOrigin: '27.8438px 149px',
        pointerEvents: 'auto',
        position: 'relative',
        quotes: '',
        r: '0px',
        ...
        touchAction: 'auto',
        transform: 'none',
        transformOrigin: '27.8438px 149px',
        transformStyle: 'flat',
        ...
        webkitLocale: 'auto',
        webkitLogicalHeight: '298px',
        webkitLogicalWidth: '55.7031px',
