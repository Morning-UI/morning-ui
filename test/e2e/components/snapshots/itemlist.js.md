...
> Snapshot 1

    {
      default: {
        ...
        ' li > i-img|height': '96px',
        ' li > i-img|padding': '0px',
        ' li > i-img|width': '96px',
        ' li|margin-top': '8px',
      ...
      size: {
        l: {
          ...
          ' li > i-img|height': '112px',
          ' li > i-img|padding': '0px',
          ' li > i-img|width': '112px',
          ' li|margin-top': '9.6px',
        ...
        xl: {
          ...
          ' li > i-img|height': '128px',
          ' li > i-img|padding': '0px',
          ' li > i-img|width': '128px',
        ...
        xxl: {
          ...
          ' li > i-img|height': '144px',
          ' li > i-img|padding': '0px',
          ' li > i-img|width': '144px',
          ' li|margin-top': '12.8px',
          ' li|padding-bottom': '12.8px',
        },
        xxs: {
