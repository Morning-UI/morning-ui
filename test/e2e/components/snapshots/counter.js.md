# Snapshot report for `test/e2e/components/counter.js`
...
> Snapshot 1

    {
      style: {
        ...
        perspective: 'none',
        perspectiveOrigin: '65px 33.8438px',
...
> Snapshot 1
    ...
    {
      default: {
        '.add-step|undefined|background-color': 'rgb(237, 241, 245)',
        '.add-step|undefined|border': '1px solid rgb(230, 230, 230)',
        '.add-step|undefined|cursor': 'pointer',
        '.sub-step|undefined|background-color': 'rgb(237, 241, 245)',
        '.sub-step|undefined|border': '1px solid rgb(230, 230, 230)',
        '.sub-step|undefined|cursor': 'pointer',
        'input|undefined|-webkit-user-select': 'text',
        'input|undefined|background-color': 'rgb(255, 255, 255)',
        'input|undefined|border': '1px solid rgb(230, 230, 230)',
        'input|undefined|color': 'rgb(179, 179, 179)',
        'input|undefined|cursor': 'auto',
      },
      state_ndr: {
        disabled: {
          '.add-step|undefined|background-color': 'rgb(235, 235, 235)',
          '.add-step|undefined|border': '1px solid rgb(166, 166, 166)',
          '.add-step|undefined|cursor': 'not-allowed',
          '.sub-step|undefined|background-color': 'rgb(235, 235, 235)',
          '.sub-step|undefined|border': '1px solid rgb(166, 166, 166)',
          '.sub-step|undefined|cursor': 'not-allowed',
          'input|undefined|-webkit-user-select': 'none',
          'input|undefined|background-color': 'rgb(235, 235, 235)',
          'input|undefined|border': '1px solid rgb(166, 166, 166)',
          'input|undefined|color': 'rgb(141, 141, 141)',
          'input|undefined|cursor': 'not-allowed',
        },
        normal: {
          '.add-step|undefined|background-color': 'rgb(237, 241, 245)',
          '.add-step|undefined|border': '1px solid rgb(230, 230, 230)',
