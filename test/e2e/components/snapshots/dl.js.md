# Snapshot report for `test/e2e/components/dl.js`
...
> Snapshot 1

    {
      style: {
        ...
        perspective: 'none',
        perspectiveOrigin: '389px 46.8906px',
        pointerEvents: 'auto',
        position: 'static',
        quotes: '',
        r: '0px',
        ...
        touchAction: 'auto',
        transform: 'none',
        transformOrigin: '389px 46.8906px',
        transformStyle: 'flat',
...
> Snapshot 1

    {
      dd: {
        ...
        baselineShift: '0px',
        blockSize: '21px',
        border: '0px none rgb(124, 139, 160)',
        borderBottom: '0px none rgb(124, 139, 160)',
        borderBottomColor: 'rgb(124, 139, 160)',
        borderBottomLeftRadius: '0px',
        borderBottomRightRadius: '0px',
        borderBottomStyle: 'none',
        borderBottomWidth: '0px',
        borderCollapse: 'separate',
        borderColor: 'rgb(124, 139, 160)',
        borderImage: 'none',
        borderImageOutset: '0px',
        borderImageRepeat: 'stretch',
        borderImageSlice: '100%',
        borderImageSource: 'none',
        borderImageWidth: '1',
        borderLeft: '0px none rgb(124, 139, 160)',
        borderLeftColor: 'rgb(124, 139, 160)',
        borderLeftStyle: 'none',
        borderLeftWidth: '0px',
        borderRadius: '0px',
        borderRight: '0px none rgb(124, 139, 160)',
        borderRightColor: 'rgb(124, 139, 160)',
        borderRightStyle: 'none',
        borderRightWidth: '0px',
        borderSpacing: '0px 0px',
        borderStyle: 'none',
        borderTop: '0px none rgb(124, 139, 160)',
        borderTopColor: 'rgb(124, 139, 160)',
        borderTopLeftRadius: '0px',
        borderTopRightRadius: '0px',
        borderTopStyle: 'none',
        borderTopWidth: '0px',
        ...
        columnFill: 'balance',
        columnGap: 'normal',
        columnRule: '0px none rgb(124, 139, 160)',
        columnRuleColor: 'rgb(124, 139, 160)',
        columnRuleStyle: 'none',
        columnRuleWidth: '0px',
        columnSpan: 'none',
        columnWidth: 'auto',
        ...
        orientation: '',
        orphans: '2',
        outline: 'rgb(124, 139, 160) none 0px',
        outlineColor: 'rgb(124, 139, 160)',
        outlineOffset: '0px',
        outlineStyle: 'none',
        outlineWidth: '0px',
        overflow: 'visible',
        ...
        paintOrder: 'fill stroke markers',
        perspective: 'none',
        perspectiveOrigin: '311.188px 10.5px',
        pointerEvents: 'auto',
        position: 'static',
        quotes: '',
        r: '0px',
        ...
        textAnchor: 'start',
        textCombineUpright: 'none',
        textDecoration: 'none solid rgb(124, 139, 160)',
        textDecorationColor: 'rgb(124, 139, 160)',
        textDecorationLine: 'none',
        textDecorationSkip: 'objects',
        textDecorationStyle: 'solid',
        textIndent: '0px',
        ...
        touchAction: 'auto',
        transform: 'none',
        transformOrigin: '311.188px 10.5px',
        transformStyle: 'flat',
        transition: 'all 0s ease 0s',
        transitionDelay: '0s',
        transitionDuration: '0s',
        ...
        webkitBackgroundClip: 'border-box',
        webkitBackgroundOrigin: 'padding-box',
        webkitBorderAfter: '0px none rgb(124, 139, 160)',
        webkitBorderAfterColor: 'rgb(124, 139, 160)',
        webkitBorderAfterStyle: 'none',
        webkitBorderAfterWidth: '0px',
        webkitBorderBefore: '0px none rgb(124, 139, 160)',
        webkitBorderBeforeColor: 'rgb(124, 139, 160)',
        webkitBorderBeforeStyle: 'none',
        webkitBorderBeforeWidth: '0px',
        webkitBorderEnd: '0px none rgb(124, 139, 160)',
        webkitBorderEndColor: 'rgb(124, 139, 160)',
        webkitBorderEndStyle: 'none',
        webkitBorderEndWidth: '0px',
        webkitBorderHorizontalSpacing: '0px',
        webkitBorderImage: 'none',
        webkitBorderStart: '0px none rgb(124, 139, 160)',
        webkitBorderStartColor: 'rgb(124, 139, 160)',
        webkitBorderStartStyle: 'none',
        webkitBorderStartWidth: '0px',
        webkitBorderVerticalSpacing: '0px',
        webkitBoxAlign: 'stretch',
        ...
        webkitLogicalWidth: '622.391px',
        webkitMarginAfter: '9.8px',
        webkitMarginAfterCollapse: 'collapse',
        webkitMarginBefore: '0px',
        webkitMarginBeforeCollapse: 'collapse',
        webkitMarginBottomCollapse: 'collapse',
        ...
        webkitTextDecorationsInEffect: 'none',
        webkitTextEmphasis: '',
        webkitTextEmphasisColor: 'rgb(124, 139, 160)',
        webkitTextEmphasisPosition: 'over',
        webkitTextEmphasisStyle: 'none',
        webkitTextFillColor: 'rgb(124, 139, 160)',
        webkitTextOrientation: 'vertical-right',
        webkitTextSecurity: 'none',
        webkitTextStroke: '',
        webkitTextStrokeColor: 'rgb(124, 139, 160)',
        webkitTextStrokeWidth: '0px',
        webkitTransformOriginX: '',
        webkitTransformOriginY: '',
        webkitTransformOriginZ: '',
      ...
      dt: {
        ...
        paintOrder: 'fill stroke markers',
        perspective: 'none',
        perspectiveOrigin: '58.3438px 10.5px',
        pointerEvents: 'auto',
        position: 'static',
        quotes: '',
        r: '0px',
        ...
        touchAction: 'auto',
        transform: 'none',
        transformOrigin: '58.3438px 10.5px',
        transformStyle: 'flat',
        transition: 'all 0s ease 0s',
        transitionDelay: '0s',
        transitionDuration: '0s',
