# Snapshot report for `test/e2e/components/select.js`
...
> Snapshot 1
    ...
    {
      default: {
        '.wrap > .morningicon|undefined|display': 'block',
        '.wrap|undefined|-webkit-user-select': 'none',
        '.wrap|undefined|background-color': 'rgb(255, 255, 255)',
        '.wrap|undefined|border-color': 'rgb(230, 230, 230)',
        '.wrap|undefined|cursor': 'pointer',
      },
      state_ndr: {
        disabled: {
          '.wrap > .morningicon|undefined|display': 'none',
          '.wrap > mor-multiinput|undefined|background': 'rgba(0, 0, 0, 0) none repeat scroll 0% 0% / auto padding-box border-box',
          '.wrap > mor-textinput|undefined|display': 'none',
          '.wrap|undefined|-webkit-user-select': 'none',
          '.wrap|undefined|background-color': 'rgb(235, 235, 235)',
          '.wrap|undefined|border-color': 'rgb(166, 166, 166)',
