# Snapshot report for `test/e2e/components/message.js`
...
> Snapshot 1

    {
      style: {
        ...
        perspective: 'none',
        perspectiveOrigin: '196.25px 8000px',
        ...
        top: '0px',
        touchAction: 'auto',
        transform: 'matrix(1, 0, 0, 1, -196.5, 0)',
        transformStyle: 'flat',
        ...
        webkitLogicalHeight: '16000px',
        webkitLogicalWidth: '392.5px',
        ...
        webkitMaxLogicalWidth: '400px',
        webkitMinLogicalHeight: '0px',
        webkitMinLogicalWidth: '320px',
