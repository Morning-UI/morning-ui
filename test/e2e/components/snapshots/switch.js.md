...
> Snapshot 1

    {
      style: {
        ...
        webkitLogicalHeight: '62px',
        webkitLogicalWidth: '50px',
...

    {
      ...
      state_ndr: {
        disabled: {
          ...
          '.track .point|undefined|background': 'rgb(205, 205, 205) none repeat scroll 0% 0% / auto padding-box border-box',
