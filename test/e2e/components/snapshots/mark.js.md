# Snapshot report for `test/e2e/components/mark.js`
...
> Snapshot 1

    {
      style: {
        ...
        background: 'rgb(250, 181, 193) none repeat scroll 0% 0% / auto padding-box border-box',
        backgroundAttachment: 'scroll',
        backgroundBlendMode: 'normal',
        backgroundClip: 'border-box',
        backgroundColor: 'rgb(250, 181, 193)',
