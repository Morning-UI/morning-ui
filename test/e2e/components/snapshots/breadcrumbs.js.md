...
> Snapshot 1
    ...
    {
      default: {
        ' li.separator|font-size': '14px',
        ' li.separator|margin': '0px 7px',
        ' li.separator|vertical-align': '-5px',
        ' li|font-size': '14px',
        ' ul|height': '22px',
      },
      size: {
        l: {
          ' li.separator|font-size': '18px',
          ' li.separator|margin': '0px 10.8px',
          ' li.separator|vertical-align': '-7px',
          ' li|font-size': '16px',
          ' ul|height': '25px',
        },
        m: {
        ...
        xl: {
          ' li.separator|font-size': '22px',
          ' li.separator|margin': '0px 13.2px',
          ' li.separator|vertical-align': '-9px',
          ' li|font-size': '18px',
          ' ul|height': '22px',
        },
        xs: {
          ' li.separator|font-size': '12px',
          ' li.separator|margin': '0px 4.8px',
          ' li.separator|vertical-align': '-5px',
          ' li|font-size': '12px',
          ' ul|height': '22px',
        },
        xxl: {
          ' li.separator|font-size': '26px',
          ' li.separator|margin': '0px 15.6px',
          ' li.separator|vertical-align': '-10px',
          ' li|font-size': '22px',
          ' ul|height': '35px',
        },
        xxs: {
          ' li.separator|font-size': '12px',
          ' li.separator|margin': '0px 2.4px',
          ' li.separator|vertical-align': '-5px',
          ' li|font-size': '12px',
          ' ul|height': '22px',
        },
