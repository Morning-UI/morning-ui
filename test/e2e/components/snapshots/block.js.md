# Snapshot report for `test/e2e/components/block.js`
...
> Snapshot 1

    {
      style: {
        ...
        perspective: 'none',
        perspectiveOrigin: '389px 42.5px',
        pointerEvents: 'auto',
        position: 'static',
        quotes: '',
        r: '0px',
        ...
        webkitPaddingAfter: '32px',
        webkitPaddingBefore: '32px',
        webkitPaddingEnd: '24px',
        webkitPaddingStart: '24px',
