# Snapshot report for `test/e2e/components/checkbox.js`
...
> Snapshot 1
    ...
    {
      default: {
        'label|undefined|-webkit-user-select': 'none',
        'label|undefined|border-color': 'rgb(36, 41, 46)',
        'label|undefined|cursor': 'pointer',
      },
      state_ndr: {
        disabled: {
          'label|undefined|-webkit-user-select': 'none',
          'label|undefined|border-color': 'rgb(210, 210, 210)',
          'label|undefined|cursor': 'not-allowed',
        },
        normal: {
          'label|undefined|-webkit-user-select': 'none',
          'label|undefined|border-color': 'rgb(36, 41, 46)',
