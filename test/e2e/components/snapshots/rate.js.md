# Snapshot report for `test/e2e/components/rate.js`

The actual snapshot is saved in `rate.js.snap`.
...
> Snapshot 1

    {
      style: {
        ...
        perspective: 'none',
        perspectiveOrigin: '83.9844px 32.5px',
        ...
        webkitLogicalHeight: '65px',
        webkitLogicalWidth: '167.969px',
